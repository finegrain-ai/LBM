...
#
# Adapted from https://github.com/advimman/lama/blob/786f5936b27fb3dacd2b1ad799e4de968ea697e7/saicinpainting/training/data/masks.py
# Changes:
# - Removed segmentation-based mask generation because 
#    A/ it's not used in official LaMa training
...
# Copied from https://github.com/advimman/lama/blob/786f5936b27fb3dacd2b1ad799e4de968ea697e7/saicinpainting/utils.py
class LinearRamp:
...
class MixedMaskGenerator:
    def __init__(self, irregular_proba=1/3, irregular_kwargs=None,
        ...
        if segm_proba > 0:
            raise NotImplementedError("Mask generation from segmentation is not implemented")
